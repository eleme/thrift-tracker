...
func (p CalculatorErrorCode) String() string {
	switch p {
	case CalculatorErrorCode_UNKNOWN_ERROR:
		return "UNKNOWN_ERROR"
	case CalculatorErrorCode_DATABASE_ERROR:
		return "DATABASE_ERROR"
	case CalculatorErrorCode_TOO_BUSY_ERROR:
...
func CalculatorErrorCodeFromString(s string) (CalculatorErrorCode, error) {
	switch s {
	case "UNKNOWN_ERROR":
		return CalculatorErrorCode_UNKNOWN_ERROR, nil
	case "DATABASE_ERROR":
		return CalculatorErrorCode_DATABASE_ERROR, nil
	case "TOO_BUSY_ERROR":
		return CalculatorErrorCode_TOO_BUSY_ERROR, nil
	}
...
func (p *CalculatorServiceClient) Add(ctx context.Context, num1 int32, num2 int32) (r int32, err error) {
	if err = p.sendAdd(ctx, num1, num2); err != nil {
		return
	}
	return p.recvAdd()
}
